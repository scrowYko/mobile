    ...
    if (!permissao.granted) {
        ...
        return (
            <View style={style.container}>
                <Text style={style.textoPermissão}>Você precisa conceder a permissão para usar a câmera</Text>
        ...
        <View>
            {foto ?
                <View>
                    ...
                    <Pressable onPress={setFoto(null)} style={style.button}><Text style={style.buttonText}>Limpar foto</Text></Pressable>
                </View> :
